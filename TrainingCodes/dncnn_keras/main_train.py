...
if __name__ == '__main__':
    ...
    history = model.fit(train_datagen(batch_size=args.batch_size),steps_per_epoch=steps_per_epoch,epochs=args.epoch, verbose=1, initial_epoch=initial_epoch,callbacks=[checkpointer,csv_logger,lr_scheduler])
